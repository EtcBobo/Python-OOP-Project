...
import newsletter.parser
import newsletter.message
import io
import re
import collections
...
class HTTPMessage(newsletter.message.Message):
...
def parse_headers(fp, _class=HTTPMessage):
    ...
    return newsletter.parser.Parser(_class=_class).parsestr(hstring)
